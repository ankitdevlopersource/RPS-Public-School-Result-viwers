...
// Defines common props for all icons to accept className for styling
interface IconProps {
    className?: string;
}

// Icon for a user or profile
...
// Icon to represent a school or building
export const SchoolIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 3L1 9l4 2.18v6.32L1 14.59 12 21l11-6.41V11.18L23 9 12 3zm0 8.69L5.66 8 12 4.31 18.34 8 12 11.69z" />
    </svg>
);
...
export const Spinner: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
// Icon for admin dashboard
export const DashboardIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 17v-2a4 4 0 00-4-4H3V9h2a4 4 0 004-4V3l5 4-5 4v-2H7v2l-4 4 4 4v-2h2a4 4 0 004-4v-2m5-2l5 4-5 4v-2h-2v-2h2v-2l5-4-5-4v2h-2v2h2v2z" />
    </svg>
);

// Icon for signature
export const SignatureIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L15.232 5.232zM11 5.5s1.5-1.5 3-1.5 3 1.5 3 1.5" />
    </svg>
);

// Icon for audit log
export const AuditLogIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
